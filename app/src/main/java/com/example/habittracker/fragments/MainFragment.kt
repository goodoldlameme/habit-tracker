...
import com.example.habittracker.model.ListViewSettings
...
@Singleton
class MainFragment @Inject constructor(private val viewModelFactory: ViewModelProvider.Factory) : Fragment(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, viewModelFactory).get(ListHabitsViewModel::class.java)
...
//        )
    ...
    private fun setUpViewModel(){
        setFragment(bottomSheetBehavior?.state
            ?: BottomSheetBehavior.STATE_COLLAPSED, viewModel.getFilteredHabits())
        viewModel.habits.observe(this, Observer { _ ->
            setFragment(bottomSheetBehavior?.state
                ?: BottomSheetBehavior.STATE_COLLAPSED, viewModel.getFilteredHabits()) })
